...
Die Persistierung muss sich nahtlos in die anderen Bausteinen der IsyFact integrieren, vollständig kompatibel mit dem <<DatenzugriffDetailkonzept>> sein und gemäß den Vorgaben des Produktkatalogs umgesetzt werden.
