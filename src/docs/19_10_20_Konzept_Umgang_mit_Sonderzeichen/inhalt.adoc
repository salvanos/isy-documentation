...
Für die Anwendungen nach IsyFact-Standard ist der zu verwendende Zeichensatz festgelegt.
...
Daten einer Anwendung nach IsyFact-Standard werden zunächst umgeschrieben und dann dem Nachbarsystem übergeben.
